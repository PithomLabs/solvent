...
--- PASS: TestW2_B24_B16_BlockedCascadeIsAtomic (0.08s)
=== RUN   TestW2_B08_AuditAfterCascade
    kernel_test.go:717: B-08 PASS — returned 0 (err=<nil>)
--- PASS: TestW2_B08_AuditAfterCascade (0.08s)
...
=== RUN   TestW3_EnsureBelief_Existing
    kernel_test.go:865: W3-Ensure-Existing PASS — id1=25dd2789-7683-4f0b-9821-0f5d2d0f78fa, id2=25dd2789-7683-4f0b-9821-0f5d2d0f78fa, same=true; count=1
--- PASS: TestW3_EnsureBelief_Existing (0.01s)
=== RUN   TestW3_EnsureBelief_DifferentScenario
    kernel_test.go:889: W3-Ensure-DiffScenario PASS — idA=b2b3c8a3-5f04-4f1b-97c9-59233df94d9a, idB=6379535a-7024-4f65-aa50-46ee85c3d915, different=true
--- PASS: TestW3_EnsureBelief_DifferentScenario (0.01s)
PASS
ok  	github.com/PithomLabs/solvent/internal/kernel	1.632s
```
...
=== RUN   TestW1_B10_I2_PromoteFinalTruth
    kernel_test.go:307: B-10 PASS — errors.Is=true; errors.As=true; sqlstate="23514"; constraint="promoted_is_debt_free"; status="entered"
--- PASS: TestW1_B10_I2_PromoteFinalTruth (0.01s)
=== RUN   TestW1_B18_RetryClassification
    kernel_test.go:372: B-18 PASS — injection=true, control txn sqlstate="40001"; Promote err=<nil>; status="promoted"; ErrPromotionBlocked=false; retry_count=unknown (crdb_internal restricted on v26.2, SQLSTATE 42501; not unlocked — see N2)
...
--- PASS: TestW3_EnsureBelief_New (0.01s)
=== RUN   TestW3_EnsureBelief_Existing
    kernel_test.go:865: W3-Ensure-Existing PASS — id1=a2f461ea-feb4-4885-b22c-6833f8cc51aa, id2=a2f461ea-feb4-4885-b22c-6833f8cc51aa, same=true; count=1
--- PASS: TestW3_EnsureBelief_Existing (0.01s)
=== RUN   TestW3_EnsureBelief_DifferentScenario
    kernel_test.go:889: W3-Ensure-DiffScenario PASS — idA=29d8b3d7-1981-401e-ba7a-f65335c51971, idB=123ed3de-5746-4bec-b334-f7244b4b551d, different=true
--- PASS: TestW3_EnsureBelief_DifferentScenario (0.01s)
PASS
ok  	github.com/PithomLabs/solvent/internal/kernel	1.886s
```
